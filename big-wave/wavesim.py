...
def run_simulation(
    ...
    if current_z < params.z_detector - z_tolerance:
        ...
        if params.is_2d:
            propagate_with_history_2d(
                ...
                skip_fft=skip_fft,
                history=None if params.use_fresnel_scaling else history,
            )
        else:
            propagate_with_history(
                u, U, params,
    ...
    if params.is_2d:
        detector_outputs = [square_and_downsample_2d(u, params, params.z_detector)]
    else:
    ...
    if snapshot is not None:
        ...
        for step in range(1, total_steps):
            ...
            if params.is_2d:
                detector_outputs.append(square_and_downsample_2d(u, params, params.z_detector))
            else:
