...
if __name__ == "__main__":
    # 创建一个示例数组
    densityAl=[2.5,2.6,2.68,2.69,2.7,2.71,2.72,2.8,2.9,3.0]
    for ii in densityAl:
        array = read_array_from_file('output_Alstair_density_'+str(ii)+'.txt')
        plt.plot(array)
        plt.legend()
        print(array[30]/array[30],array[49]/array[30],array[73]/array[30],array[100]/array[30],array[125]/array[30])
    plt.show()
